...
> Python 3.11 + FastAPI backend · Vanilla HTML/CSS/JS frontend · SQLite · Railway + Vercel deployment.
...
- ✅ **Fast deployment**: One-click deployment to Railway (backend) and Vercel (frontend)
